...
function Content1() {
  ...
  <div className="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-80 mx-2">
    <div className="z-0 order-1 md:order-2 relative w-full md:w-2/5 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-r-lg">
     ...
     <Link to='/perawatan'>  <h3 className="w-full font-bold text-2xl text-white leading-tight mb-2">Jasa  Pembuatan  Taman 
Indoor & Outdoor</h3>  </Link>
    ...
    <div className="z-10 order-2 md:order-1 w-full h-full md:w-3/5 flex items-center -mt-6 md:mt-0">
      ...
      <Link to='/perawatan'>    <h3 className="hidden md:block font-bold text-2xl text-gray-700 md:mb-5">Jasa  Pembuatan  Taman 
        Indoor & Outdoor</h3> </Link>
        ...
        <Link to='/perawatan' className="flex items-baseline mt-3 text-blue-600 hover:text-blue-900 focus:text-blue-900" >
            <Button2 />
        </Link>
      </div>
    </div>
