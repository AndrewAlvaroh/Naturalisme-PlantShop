...
function Footer() {
	return (
		<div>
		<footer className="py-6 " style={{backgroundColor: "#7EB5A6"}}>
	<div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
		<div className="grid grid-cols-12">
			...
			<div className="col-span-6 text-center md:text-left md:col-span-4 md:my-10">
				<p className="pb-1 text-lg font-medium text-white">Contact</p>
		...
		<div className="grid justify-center pt-6">
			<div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
				<span className="text-white">©2021 Naturalisme | All rights reserved</span>
