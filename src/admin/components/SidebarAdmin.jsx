...
function SidebarAdmin() {
    return (
        <div className="flex flex-no-wrap">
            ...
            <div className="w-64 absolute sm:relative bg-gray-100 shadow md:h-full flex-col justify-between flex sm:flex">
                <div className="px-8">
                    <div className="h-16 w-full flex items-center">
                        <img src="/Images/logo.png" alt="logo" className="mt-5" />
                    </div>
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-green-700 hover:text-green-600 cursor-pointer items-center mb-6">
            ...
            <div className="w-64 z-40 absolute bg-gray-100 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out" id="mobile-nav">
                ...
                <div className="px-8 border-t border-gray-700">
                    <ul className="w-full flex items-center justify-between bg-gray-100">
                        <li className="cursor-pointer text- pt-5 pb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bell" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                                <path d="M10 5a2 2 0 0 1 4 0a7 7 0 0 1 4 6v3a4 4 0 0 0 2 3h-16a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6" />
                                <path d="M9 17v1a3 3 0 0 0 6 0v-1" />
